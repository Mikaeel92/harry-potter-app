...
const App = () => {
  ...
  return (
    <div className='text-5xl'>
      <Router>
        <nav className='bg-green-950 text-white flex justify-center gap-2 p-4'>
        ...
        <NavLink to='/favorites' className={ ({ isActive }) => isActive ? 'text-white flex gap-2 px-2' : 'text-gray-400 flex gap-2 px-2'}>My Favorites<FaHeart/></NavLink>
        </nav>
        <Routes>
